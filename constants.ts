...
export const PMPML_BUSES: BusRoute[] = [
  ...
  // Hadapsar to Katraj
  { route_number: '301', origin: 'Hadapsar', destination: 'Katraj', firstBus: '4:40', lastBus: '22:45', frequency: '30 min', stopsCount: 29, travelTime: '67 min', approx_distance_km: 15, estimatedPrice: 25 },
  ...
  { route_number: '317', origin: 'Pune Station', destination: 'Shivajinagar', firstBus: '5:00', lastBus: '21:30', frequency: '120 min', stopsCount: 4, approx_distance_km: 3, estimatedPrice: 10 },
  ...
  { route_number: '317', origin: 'Nigdi', destination: 'Shivajinagar', firstBus: '5:00', lastBus: '23:00', frequency: '50 min', stopsCount: 28, approx_distance_km: 18, estimatedPrice: 30 },
];
